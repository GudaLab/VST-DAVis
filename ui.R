...
#####################multiple_samples QC_before filtering##########################
       ...
       tabPanel(
         ...
         box(id = "m_bf_box0", width = 12,
             ...
             HTML("<h5 style='color:black;'>Within each ZIP file, the internal folder and file names must exactly match the output format generated by Space Ranger. Longer file names should be separated using underscores. Refer the below image or example dataset.</h5>"),
