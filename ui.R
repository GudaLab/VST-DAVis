...
#####################multiple_samples QC_before filtering##########################
       ...
       tabPanel(
         ...
         box(id = "m_bf_box0", width = 12,
             ...
             br(),
             a(href="example_files/P1_ON1_A.zip", "H5 File and spatial image files",download=NA, target="_blank"),
             br(),
             tags$b("SpaceRanger Matrix, Feauture, Barcodes and spatial image files"),
             br(),
             a(href="example_files/control_e14_3.zip", "Matrix, Feauture, Barcodes and spatial image files",download=NA, target="_blank"),
             br(),
            ),
