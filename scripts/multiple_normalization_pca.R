...
datainput_multiple_normalization_pca <- function(
    ...
    multiple_sample_normalization_method1,              # "cca" | "rpca"
  ...
  if (!multiple_sample_normalization_method1 %in% c("cca","rpca")) {
    stop("multiple_sample_normalization_method1 must be 'cca' or 'rpca'")
  }
  ...
  if (index_multiple_sample_normalization_method == "LogNormalize") {
    if (nsamp == 1) {
      ...
      anchors <- Seurat::FindIntegrationAnchors(object.list = obj_list, anchor.features = feats,
                                                ...
                                                reduction = multiple_sample_normalization_method1,
